...
# Lista para almacenar los datos de los ángulos por frame
angles_data = []
...
with mp_hands.Hands(
    ...
    while True:
        ...
        frame_data = {"frame": frame_count, "angles": []}
        ...
        if results.multi_hand_landmarks:
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                # Agregar los ángulos al diccionario de datos del frame actual
                frame_data["angles"].append({
                    "thumb": angle_thumb,
                    "index": angle_index,
                    "middle": angle_middle,
                    "ring": angle_ring,
